...
# Parameter:
# $default_editors_to_team_members
#
# Scripts Using this Parameter:
# user_permissions_loader.rb
...
#
# Description:
# When true, users created with default Editor rights everywhere
# will also be designated as Team Members everywhere
#
# Valid Settings:
# $default_editors_to_team_members = true
# $default_editors_to_team_members = false
$default_editors_to_team_members    = false
...
#
# Description:
# When running with $upgrade_only_mode == true, the script will
# check existing permissions before applying a change.
# It will then apply the change _only_ if the proposed
...
#
# This is convenient when seeking to grant Viewer level access to all
# users, without downgrading existing editors, as an example
#
# Valid Settings:
...
#
# Description:
# When running in $test_mode == true
# the loader scripts will break the load process after the specified number of maximum
# workspaces/projects
#
# This is convenient when the desire is to do test/Proof-of-Concept loads when in
# a Subscription with many workspaces/projects
#
# Valid Settings:
# $test_mode = true
# $test_mode = false
